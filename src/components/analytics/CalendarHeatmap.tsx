		...
		<Card className="p-6">
			<div className="mb-6">
				...
				<p className="text-sm text-muted-foreground">
					Activity from {new Date(startDate).toLocaleDateString()} to{" "}
						...
						<div key={weekIndex} className="flex space-x-1 items-center">
							...
							{week.map((date, dayIndex) => {
								...
								return (
									<div
										key={date}
										className="w-3 h-3 rounded-sm border border-border cursor-pointer hover:scale-110 transition-all duration-200"
